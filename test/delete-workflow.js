...
describe('Test case for Trigger on Delete OE Workflow-engine [ not workflow dependent ]', function CB() {
  var testVars = {};
  var modelName = 'WorkflowTester1';
  ...
  it('check if workflow instance is up', function CB(done) {
    models[modelName].workflow(testVars.instanceId, User1Context, function CB(err, instance) {
      ...
      assert.equal(instance.workflowDefinitionName, 'ExclusiveGateway1');
      done();
    });
  });
...
describe('Test case for Trigger on Delete OE Workflow-engine [ workflow dependent ] - Approved', function CB() {
  this.timeout(10000);
  var User1Context = _.cloneDeep(User1ContextGlobal);
  var User2Context = _.cloneDeep(User2ContextGlobal);
  var testVars = {};
  var modelName = 'WorkflowTester2';
  var modelNamePlural = modelName + 's';
  var wfName = 'ExclusiveGateway1';
  ...
  it('check if workflow instance is up [Approved]', function CB(done) {
    models[modelName].workflow(testVars.instanceId, User1Context, function CB(err, instance) {
      ...
      assert.isNotNull(instance.workflowDefinitionName);
      testVars._workflowRef = instance.id;
      if (typeof (instance.id) === 'object') {
        testVars._workflowRef = instance.id.toString();
      }
  ...
  it('end update request [ through OE Workflow-engine ] [Approved]', function CB(done) {
...
describe('Test case for Trigger on Delete OE Workflow-engine [ workflow dependent ] - rejected', function CB() {
  this.timeout(10000);
  var User1Context = _.cloneDeep(User1ContextGlobal);
  var User2Context = _.cloneDeep(User2ContextGlobal);
  var testVars = {};
  var modelName = 'WorkflowTester3';
  var modelNamePlural = modelName + 's';
  var wfName = 'ExclusiveGateway1';
  ...
  it('end update request [ through OE Workflow-engine ] [Rejected]', function CB(done) {
    models.WorkflowManager.endAttachWfRequest({
      workflowInstanceId: testVars._workflowRef,
      status: 'rejected'
    }, User1Context
