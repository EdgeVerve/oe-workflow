...
describe('Test case1 for Multi Instance Parallel subProcess', function callback() {
  this.timeout(20000);
  var name = 'ParallelMultiInstanceSubProcess';
  var testVars = {};
  ...
  it('complete task 1 of sub process 1', function callback(done) {
  ...
  it('validate subProcesses 1', function callback(done) {
    models.ProcessInstance.findById(testVars.subProcess[0].id, bootstrap.defaultContext, function callback(err, instance) {
      if (err) {
        return done(err);
      }
      assert.isNotNull(instance);
  ...
  it('validate main process', function callback(done) {
    models.ProcessInstance.findById(testVars.mainProcess.id, bootstrap.defaultContext, function callback(err, instance) {
      ...
      assert.isNotNull(instance);
      var expectedTokens = [{ 'name': 'Start', 'status': 'complete' },
        { 'name': 'TaskA', 'status': 'pending', 'nrOfCompleteInstances': 1 }
      ];
  ...
  it('validate tasks of subProcesses 2', function callback(done) {
    testVars.subProcess[1].tasks({}, bootstrap.defaultContext, function callback(err, tasks) {
      if (err) {
        return done(err);
      }
      assert.isNotNull(tasks);
  ...
  it('complete task 1 of sub process 2', function callback(done) {
    testVars.tasks[0].completeTask({}, {}, bootstrap.defaultContext, function callback(err) {
      if (err) {
        return done(err);
      }
  ...
  it('validate subProcesses 2', function callback(done) {
    models.ProcessInstance.findById(testVars.subProcess[1].id, bootstrap.defaultContext, function callback(err, instance) {
      if (err) {
        return done(err);
      }
      assert.isNotNull(instance);
  ...
  it('validate tasks of subProcesses 3', function callback(done) {
    testVars.subProcess[2].tasks({}, bootstrap.defaultContext, function callback(err, tasks) {
      if (err) {
        return done(err);
      }
      assert.isNotNull(tasks);
  ...
  it('complete task 1 of sub process 3', function callback(done) {
    testVars.tasks[0].completeTask({}, {}, bootstrap.defaultContext, function callback(err) {
      if (err) {
        return done(err);
      }
  ...
  it('validate subProcesses 3', function callback(done) {
    models.ProcessInstance.findById(testVars.subProcess[2].id, bootstrap.defaultContext, function callback(err, instance) {
      if (err) {
        return done(err);
      }
      assert.isNotNull(instance);
